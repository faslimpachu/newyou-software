...
const consultations = [{id:'OP-260712-014',name:'Aarav Sharma',mr:'MR000001',clinician:'Dr. Neha Verma',reason:'Diet review',status:'In Progress'},{id:'OP-260712-015',name:'Rohan Mehta',mr:'MR000002',clinician:'Dr. Arjun Das',reason:'Wellness consultation',status:'Signed'}]
const followups = [{id:'FU-2021',name:'Aarav Sharma',mr:'MR000001',address:'Bengaluru',phone:'98450 12345',program:'Diet review',due:'Today, 03:30 PM',assigned:'Dr. Neha Verma',status:'Due today'},{id:'FU-2022',name:'Rohan Mehta',mr:'MR000002',address:'Pune',phone:'90080 33221',program:'Therapy review',due:'14 Jul 2026',assigned:'Dr. Arjun Das',status:'Scheduled'}]
